...
\chair{Professor Wick C. Haxton}
\othermembers{Professor Joel E. Moore \\
...
From the beginning, my parents have always nurtured curiosity about the world around me and held me to high but fair expectations. Many of my earliest memories are of classes at the Pacific Science Center and the Seattle Aquarium where I learned about topics ranging from how viscosity works to the anatomy of squid. When the elementary school librarian thought I wasn't ready for chapter books, a teacher didn't want me to skip a level in math, or anyone didn't believe I was ready for more advanced material, my parents fought for me and taught me to fight for myself. My mother served as one of my many teachers during my years of homeschooling, providing opportunities to learn and grow in unique ways outside the normal school system. Of course, their constant example of loving others and providing help to those in need is just as important.
...
\include{ChiralPotential/ChiralPotential}
...
\include{ChiralPotential/CPAppendix}

\include{LocalExpansion/LEAppendix}
