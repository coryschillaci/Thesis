...
\includegraphics[scale=0.5,page=1]{Introduction/Figures/LO} 
\includegraphics[scale=0.5,page=2]{Introduction/Figures/LO}
} & &  \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
...
\includegraphics[scale=0.5,page=1]{Introduction/Figures/NLO}
...
\includegraphics[scale=0.5,page=2]{Introduction/Figures/N2LO}
\includegraphics[scale=0.5,page=3]{Introduction/Figures/N2LO} 
\includegraphics[scale=0.5,page=1]{Introduction/Figures/ellipsis} 
%$+\dots$
}  &  
\parbox[c][][c]{5.8cm}{\centering
\includegraphics[scale=0.5,page=4]{ChiralPotential/Figures/3NFDiagrams}
\includegraphics[scale=0.5,page=3]{ChiralPotential/Figures/3NFDiagrams}
\includegraphics[scale=0.5,page=2]{ChiralPotential/Figures/3NFDiagrams}
} & \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
...
\includegraphics[scale=0.5,page=1]{Introduction/Figures/N3LO}
