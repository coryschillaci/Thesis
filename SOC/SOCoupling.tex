\chapter{\label{chap:SOC}bEnergy spectra of two interacting fermions with spin-orbit coupling in a harmonic trap}
...
\begin{figure}
\centering
\includegraphics{SOC/Figures/BuschSpectrum}
...
\begin{figure}
\centering
\includegraphics{SOC/Figures/PerturbativeComparison}
...
\begin{figure}
\centering
\includegraphics{SOC/Figures/ComparisonNoCM}
\caption{\label{fig:ComparisonSpectrum2}  A comparison of the energy levels with (dashed black) and without (solid red) the inclusion of excitations in the c.m. coordinate for $\tilde{a}=-1$. The approximation of ignoring c.m. excitations provides very accurate results for the ground state, but not for excited states.} 
\end{figure}
...
We thank Paulo Bedaque, Jordy de Vries and Timo L{\"a}hde for their input and discussions related to this work. This paper is based in part on work supported by the U.S. Department of Energy, Office of Science, Office of Nuclear Physics, under Award No. DE-SC00046548. 
